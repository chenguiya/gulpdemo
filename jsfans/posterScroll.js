...
(function(jq){
	...
	posterTvGrid.prototype = {
		reset: function(options){
			...
			if(parseInt(this.body.outerWidth())>1440 || navigator.userAgent.indexOf('iPad') !== -1){
				this.options.width = 1400;
				this.nextLeft = this.options.width-962;
				this.minwidth=530;
				this.minheight=375;
				this.two_width=862;
				this.two_height=610;
				...
				this.nextLeft = this.options.width-586;
		...
		initContent: function(){
			...
			this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 1, left: this.preLeft+'px',height: this.two_height, width:this.two_width, zIndex: 1, marginTop: '28px'});
			...
			this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 1, left: this.nextLeft+'px',height: this.two_height, width: this.two_width, zIndex: 1, marginTop: '28px'});
		...
		turnpage: function(page, dir){
			...
			var run = function(page, dir, t){
				...
				if(dir == 'left'){					
					...
					_this.parent.find(".contentHolderUnit:nth-child("+preP+")").animate({ opacity: 1,left:'0px',width:_this.minwidth,height:_this.minheight, zIndex:0, marginTop: _this.margintop},t, "", function(){_this.locked=false;});
					_this.parent.find(".contentHolderUnit:nth-child("+preP+") .elementOverlay").css({opacity:0.6});
					...
					//_this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 1, left: _this.nextNLeft+'px', height: '375px', width: '530px', zIndex: 2, marginTop: '85px'});
					...
					_this.parent.find(".contentHolderUnit:nth-child("+nextN+")").css({opacity:0.6});
					...
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 1, left: _this.preNLeft+'px', height: _this.minheight, width: _this.minwidth, zIndex: 2, marginTop: '85px'});
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height:_this.two_height, width: _this.two_width, zIndex: 2, marginTop: '28px'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+preP+")").animate({width:_this.minwidth,height:_this.minheight, opacity: 1, left:'0px', zIndex:0, marginTop: '145px'},t, "", function(){_this.locked=false;});
					_this.parent.find(".contentHolderUnit:nth-child("+preP+") .elementOverlay").css({opacity:0.4});
					
					_this.parent.find(".contentHolderUnit:nth-child("+nextN+")").animate({width:_this.minwidth,height:_this.minheight, opacity: 1,zIndex:0, left:_this.nheight+'px', zIndex:0, marginTop: _this.margintop}, t, "",function(){_this.locked=false;});
					_this.parent.find(".contentHolderUnit:nth-child("+nextN+")").css({opacity:0.6});
				}
