	...
	posterTvGrid.prototype = {
		reset: function(options){
			...
			if(parseInt(this.body.outerWidth())>1255 || navigator.userAgent.indexOf('iPad') !== -1){
				...
				this.nextLeft = this.options.width-862;
				this.two_width=862;
				this.two_height=610;
			}else{
				...
				this.nextLeft = this.options.width-466;
				this.two_width=466;
				this.two_height=330;
			...
			this.pageNowLeft = (this.options.width-this.options.maxwidth)/2
			this.drawContent();
		},
		...
		initContent: function(){
			...
			contentHolderUnit.css({width:'0px',height:'0px', opacity: 0, left:this.options.width/2+'px', zIndex:0, marginTop: '145px'});
			...
			this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 1, left: this.preLeft+'px',height: this.two_height, width:this.two_width, zIndex: 0, marginTop: '28px'});
			this.parent.find(".contentHolderUnit:nth-child("+pre+") .elementOverlay").css({opacity:0.6});
			...
			this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 1, left: this.nextLeft+'px',height: this.two_height, width: this.two_width, zIndex: 0, marginTop: '28px'});
			this.parent.find(".contentHolderUnit:nth-child("+next+") .elementOverlay").css({opacity:0.6});
		...
		turnpage: function(page, dir){
			...
			var run = function(page, dir, t){
				...
				if(pre != _this.pageNow && next != _this.pageNow){
					...
					_this.parent.find(".contentHolderUnit:nth-child("+nowpre+")").animate({width:'0px',height:'0px', opacity: 0, left:_this.options.width/2+'px', zIndex:0, marginTop: '145px'}, t);
					_this.parent.find(".contentHolderUnit:nth-child("+_this.pageNow+")").animate({width:'0px',height:'0px', opacity: 0, left:_this.options.width/2+'px', zIndex:0, marginTop: '145px'}, t);
					_this.parent.find(".contentHolderUnit:nth-child("+nownext+")").animate({width:'0px',height:'0px', opacity: 0, left:_this.options.width/2+'px', zIndex:0, marginTop: '145px'}, t);
				}
				if(dir == 'left'){					
					...
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: _this.two_height, width: _this.two_width, zIndex: 2, marginTop: '28px'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 0, left: _this.nextNLeft+'px', height: '375px', width: '530px', zIndex: 2, marginTop: '85px'});
					_this.parent.find(".contentHolderUnit:nth-child("+next+")").animate({opacity: 1, left: _this.nextLeft+'px', height: _this.two_height, width:_this.two_width, zIndex: 2, marginTop: '28px'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+preP+")").animate({width:'530px',height:'375px', opacity: 0, left:_this.preNLeft+'px', zIndex:0, marginTop: '85px'},t, "", function(){_this.locked=false;});
					...
					_this.parent.find(".contentHolderUnit:nth-child("+next+")").animate({opacity: 1, left: _this.nextLeft+'px', height: _this.two_height, width: _this.two_width, zIndex: 2, marginTop: '28px'}, t);
					_this.parent.find(".contentHolderUnit:nth-child("+next+") .elementOverlay").css({opacity:0.6});
					_this.parent.find(".contentHolderUnit:nth-child("+next+") .leftShadow").css({opacity:0});
					_this.parent.find(".contentHolderUnit:nth-child("+next+") .rightShadow").css({opacity:0});
					...
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 0, left: _this.preNLeft+'px', height: '375px', width: '530px', zIndex: 2, marginTop: '85px'});
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height:_this.two_height, width: _this.two_width, zIndex: 2, marginTop: '28px'}, t);
					_this.parent.find(".contentHolderUnit:nth-child("+pre+") .elementOverlay").css({opacity:0.6});
					_this.parent.find(".contentHolderUnit:nth-child("+pre+") .leftShadow").css({opacity:0});
					_this.parent.find(".contentHolderUnit:nth-child("+pre+") .rightShadow").css({opacity:0});
					
					_this.parent.find(".contentHolderUnit:nth-child("+nextN+")").css({zIndex:0});
					_this.parent.find(".contentHolderUnit:nth-child("+nextN+")").animate({width:'530px',height:'375px', opacity: 0, left:_this.nextNLeft+'px', zIndex:0, marginTop: '85px'}, t, "",function(){_this.locked=false;});
				}
